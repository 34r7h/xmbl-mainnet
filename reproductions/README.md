...
| `storage-compute.mjs` | `storage-compute` | A guest that loops forever is killed at the operator's deadline and still billed at the maximum; a genuine job is metered; custody is proved from the shard's bytes |
